 ...
 */
final class Version20241125180826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE grade (id INT NOT NULL, student_id INT NOT NULL, value INT NOT NULL, PRIMARY KEY(id))');
